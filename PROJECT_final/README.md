...
**Техническая задача как для специалиста в Data Science:** построить модель оптимальную модель прогнозирования с упаковкой с возможностью использования в продакшене - в контейнере Docker.
...
5. Сформировать конфигурацию для успешного запуска и получения прогноза на заданную дату.
...
За каждое задание можно получить **от 1 до 3 баллов**.
<!-- <table>
  <tbody>
    <tr style="vertical-align:middle">
