...
* Выполнено предсказание по вероятности ухода конкретного клиента. Клиент перестанет пользоваться услугами банка, вероятность прекратить сотрудничество с банком - более 60%.
